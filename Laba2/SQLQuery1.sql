...
(
	...
	[Employment_type] NVARCHAR(50) NOT NULL CHECK (Employment_type in('Полная', 'Частичная', 'Вахта')),
	[Work_format] NVARCHAR(30) NOT NULL CHECK (Work_format in ('На месте', 'Удаленно', 'Разъезды')),
